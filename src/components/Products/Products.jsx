    ...
    <main className={classes.mainPage}>
      ...
      <div className={classes.carouselSection}>
        <Carousel
          ...
          showStatus={false}
        >
          {[mangaBg, bioBg, fictionBg].map((bgImage, index) => (
            <div key={index}>
              <Link to={['manga', 'biography', 'fiction'][index]}>
                <button
                  className={classes.categoryButton}
      ...
      {searchTerm === '' && (
        <>
          <div>
            ...
            <Grid className={classes.contentFeatured} container justify="center" spacing={1}>
